...
public class EgovSampleController {
	...
	public String spreadJsTest(SampleVO sampleVO, @ModelAttribute("searchVO") SampleDefaultVO searchVO, SessionStatus status) throws Exception {
		
		return "sample/spreadTest";
	}
